...
export function IdeaLibraryDialog({ bare = false }: { bare?: boolean }) {
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent>
        <DrawerHeader>
          <DrawerTitle>Minispiel & Regel Vorschläge</DrawerTitle>
          <DrawerDescription>
        ...
        <div className="max-h-[55vh] space-y-5 overflow-y-auto px-4 pb-4">
          <div className="space-y-2">
            <p className="text-sm font-medium text-muted-foreground">
              Minispiel Ideen ({minigames.length})
            </p>
